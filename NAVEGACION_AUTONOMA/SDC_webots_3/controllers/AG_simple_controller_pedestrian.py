...
# Buscar en varios lugares posibles para soporte de ruta ASCII y original
POSSIBLE_PATHS = [
    os.path.normpath(os.path.join(_CTRL_DIR, '..', 'pedestrian_svm.joblib')),       # SDC_webots_3/pedestrian_svm.joblib
    os.path.normpath(os.path.join(_CTRL_DIR, '..', '..', 'pedestrian_svm.joblib')), # original parent /Semana_5/Actividad.../pedestrian_svm.joblib
    os.path.normpath(os.path.join(_CTRL_DIR, 'pedestrian_svm.joblib')),             # En el mismo directorio controllers
]
MODEL_PATH = None
...
if MODEL_PATH is None:
    # Por defecto, usar la ruta original como fallback de impresión de error
